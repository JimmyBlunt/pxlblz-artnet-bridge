...
if errorlevel 1 exit /b 1
go build -trimpath -ldflags "-s -w" -o dist\windows\pxlblz-receiver-probe.exe .\cmd\pxlblz-receiver-probe
if errorlevel 1 exit /b 1
...
copy /Y dist\windows\pxlblz-receiver-probe.exe pxlblz-receiver-probe.exe >nul
